...
import org.guanzon.cas.model.parameters.Model_Region;
import org.json.simple.JSONObject;

public class Region implements GRecord {
    ...
    ArrayList<Model_Region> poModelList = new ArrayList<>();
    JSONObject poJSON;

    public Region(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Region(foGRider);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModel.makeSelectSQL(), " sRegionNm LIKE "
    ...
    public ArrayList<Model_Region> getModelList() {
        return poModelList;
    }
}
