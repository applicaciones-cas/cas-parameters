...
import org.guanzon.cas.model.parameters.Model_Relationship;
import org.json.simple.JSONObject;

public class Relationship implements GRecord {
    ...
    ArrayList<Model_Relationship> poModelList = new ArrayList<>();
    JSONObject poJSON;

    public Relationship(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Relationship(foGRider);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModel.makeSelectSQL(), " sRelatnDs LIKE "
    ...
    public ArrayList<Model_Relationship> getModelList() {
        return poModelList;
    }
}
