...
import org.guanzon.cas.model.parameters.Model_Country;
...
public class Country implements GRecord {
    ...
    ArrayList<Model_Country> poModelList = new ArrayList<>();
    JSONObject poJSON;
    ...
    public Country(GRider foGRider, boolean fbWthParent) {
        ...
        poModel = new Model_Country(foGRider);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModel.makeSelectSQL(), " sCntryNme LIKE "
