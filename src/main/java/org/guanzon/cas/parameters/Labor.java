...
import org.guanzon.cas.model.parameters.Model_Labor;
import org.json.simple.JSONObject;

public class Labor implements GRecord {
    ...
    Model_Labor poModel;
    ArrayList<Model_Labor> poModelList = new ArrayList<>();
    JSONObject poJSON;

    public Labor(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Labor(foGRider);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModel.makeSelectSQL(), " sLaborNme LIKE "
    ...
    public JSONObject loadModelList() {
        ...
        try {
            ...
            while (loRS.next()) {
                Model_Labor List = new Model_Labor(poGRider);
    ...
    public ArrayList<Model_Labor> getModelList() {
        return poModelList;
    }
}
