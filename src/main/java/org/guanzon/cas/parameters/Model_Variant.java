...
public class Model_Variant implements GRecord {
    ...
    public Model_Variant(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Model_Variant(foGRider);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(MiscUtil.makeSQL(poModel), lsCondition);
    ...
    public JSONObject loadModelList() {
        ...
        try {
            ...
            Logger.getLogger(Model_Variant.class.getName()).log(Level.SEVERE, null, ex);
            loJSON.put("result", "error");
    ...
    public JSONObject searchMaster(String fsColumn, String fsValue, boolean fbByCode) {
        ...
        switch (fsColumn) {
            case "sBrandCde":
                ...
                if (loJSON != null) {
                    poModel.setBrandCode((String) loBrand.getMaster("sBrandCde"));
