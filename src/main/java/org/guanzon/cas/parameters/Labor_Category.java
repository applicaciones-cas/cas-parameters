...
import org.guanzon.cas.model.parameters.Model_Labor_Category;
import org.json.simple.JSONObject;

public class Labor_Category implements GRecord {
    ...
    public Labor_Category(GRider foGRider, boolean fbWthParent) {
        ...
        poModel = new Model_Labor_Category(foGRider);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModel.makeSelectSQL(), " sCategrCd LIKE "
                + SQLUtil.toSQL(fsValue + "%") + " AND " + lsCondition);

        poJSON = ShowDialogFX.Search(poGRider,
                lsSQL,
                fsValue,
                "ID»Labor Category Name",
                "sLaborIDx»sCategrCd",
                "sLaborIDx»sCategrCd",
                fbByCode ? 0 : 1);
...
//additional methods
    ...
    public JSONObject loadModelList() {
        ...
        try {
            ...
            Logger.getLogger(Labor_Category.class.getName()).log(Level.SEVERE, null, ex);
            loJSON.put("result", "error");
    ...
    public ArrayList<Model_Labor_Category> getModelList() {
        return poModelList;
    }
}
