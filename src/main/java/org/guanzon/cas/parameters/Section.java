...
import org.guanzon.cas.model.parameters.Model_Section;
import org.json.simple.JSONObject;

public class Section implements GRecord {
    ...
    ArrayList<Model_Section> poModelList = new ArrayList<>();
    JSONObject poJSON;

    public Section(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Section(foGRider);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModel.makeSelectSQL(), " sSectnNme LIKE "
...
//additional methods
    ...
    public ArrayList<Model_Section> getModelList() {
        return poModelList;
    }
}
