...
import org.guanzon.cas.model.parameters.Model_Affiliated_Company;
import org.json.simple.JSONObject;

public class Affiliated_Company implements GRecord {
    ...
    public Affiliated_Company(GRider foGRider, boolean fbWthParent) {
        ...
        poModel = new Model_Affiliated_Company(foGRider);
...
//additional methods
    ...
    public JSONObject loadModelList() {
        ...
        try {
            ...
            while (loRS.next()) {
                Model_Affiliated_Company List = new Model_Affiliated_Company(poGRider);
            ...
            Logger.getLogger(Affiliated_Company.class.getName()).log(Level.SEVERE, null, ex);
            loJSON.put("result", "error");
    ...
    public ArrayList<Model_Affiliated_Company> getModelList() {
        return poModelList;
    }
}
