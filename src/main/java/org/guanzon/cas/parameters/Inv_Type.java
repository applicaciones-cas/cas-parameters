...
import org.guanzon.cas.model.parameters.Model_Inv_Type;
import org.json.simple.JSONObject;

public class Inv_Type implements GRecord {
    ...
    ArrayList<Model_Inv_Type> poModelList = new ArrayList<>();
    JSONObject poJSON;

    public Inv_Type(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Inv_Type(foGRider);
    ...
    public JSONObject loadModelList() {
        ...
        try {
            ...
            Logger.getLogger(Inv_Type.class.getName()).log(Level.SEVERE, null, ex);
            loJSON.put("result", "error");
    ...
    public ArrayList<Model_Inv_Type> getModelList() {
        return poModelList;
    }
}
