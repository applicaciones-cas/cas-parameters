...
import org.guanzon.cas.model.parameters.Model_Made;
import org.json.simple.JSONObject;

public class Made implements GRecord {
    ...
    public Made(GRider foGRider, boolean fbWthParent) {
        ...
        poModel = new Model_Made(foGRider);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModel.makeSelectSQL(), " sMadeName LIKE "
    ...
    public JSONObject loadModelList() {
        ...
        try {
            ...
            Logger.getLogger(Made.class.getName()).log(Level.SEVERE, null, ex);
            loJSON.put("result", "error");
    ...
    public ArrayList<Model_Made> getModelList() {
        return poModelList;
    }
}
