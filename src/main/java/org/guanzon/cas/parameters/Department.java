...
import org.guanzon.cas.model.parameters.Model_Department;
...
public class Department implements GRecord {
    ...
    ArrayList<Model_Department> poModelList = new ArrayList<>();
    JSONObject poJSON;

    public Department(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Department(foGRider);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModel.makeSelectSQL(), " sDeptName LIKE "
...
//additional methods
    ...
    public ArrayList<Model_Department> getModelList() {
        return poModelList;
    }
}
