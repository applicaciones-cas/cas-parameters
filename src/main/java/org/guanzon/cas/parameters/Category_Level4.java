...
import org.guanzon.cas.model.parameters.Model_Category_Level4;
import org.json.simple.JSONObject;

public class Category_Level4 implements GRecord {
    ...
    ArrayList<Model_Category_Level4> poModelList = new ArrayList<>();
    JSONObject poJSON;

    public Category_Level4(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Category_Level4(foGRider);
    ...
    public JSONObject loadModelList() {
        ...
        try {
            ...
            while (loRS.next()) {
                Model_Category_Level4 List = new Model_Category_Level4(poGRider);
            ...
            Logger.getLogger(Category_Level4.class.getName()).log(Level.SEVERE, null, ex);
            loJSON.put("result", "error");
    ...
    public ArrayList<Model_Category_Level4> getModelList() {
        return poModelList;
    }
}
